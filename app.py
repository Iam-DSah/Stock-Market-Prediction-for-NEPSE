...
def get_portfolio():
    ...
    total_value = 0  # Variable to store total portfolio value
    ...
    for item in portfolio:
        ...
        latest_close = None  # Store the latest stock price
        ...
        stock_total = round(quantity * latest_close, 2) if latest_close else None
        total_value += stock_total if stock_total else 0  # Add stock value to total
    ...
    return jsonify({'portfolio': result, 'total_value': round(total_value, 2)})  # Add total value
